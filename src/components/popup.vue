  ...
  <div class="popup_outside" v-show="showpo">
    ...
    <div class="main_popup">
      ...
      <div class="modify_phone" v-if="show_phone">
        ...
        <div class="now_phone"><span class="now_phone_span">当前手机号：13123242345</span></div>
        ...
        <div class="phone_success">
          <el-button type="success" plain class="pho_btn">提交</el-button>
        </div>
      ...
      <div class="modify_email" v-if="show_email">
        ...
        <div class="now_email"><span class="now_email_span">当前邮箱：13123242345@qq.com</span></div> 
        ...
        <div class="email_success">
          <el-button type="success" plain class="email_btn">提交</el-button>
        </div>
      </div>
      ...
      <div class="modify_password" v-if="show_password">
        ...
        <div class="old_password"><el-input v-model="old_password" placeholder="请输入当前密码"></el-input></div>
        <div class="new_password"><el-input v-model="new_password" placeholder="请输入新密码"></el-input></div>
        <div class="password_success">
          <el-button type="success" plain class="password_btn">提交</el-button>
        </div>
      </div>
    </div>
  </div>
